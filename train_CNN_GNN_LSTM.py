...
def main():
    ...
    # # upramp1_raw = loaddata_preproc_v2(filepath='./data_v2_20250808/wdh/216.bin',startpoint=500,endpoint=3500,data_png_name='21.png')#上坡,label=2
    ...
    # # downramp1_raw = loaddata_preproc_v2(filepath='./data_v2_20250808/wdh/215.bin',startpoint=500,endpoint=3500,data_png_name='31.png')#下坡,label=3
...
# 导入数据集
    ...
    joblib.dump(scaler, "cnn_gnn_bilstm_scaler.save")  # 方法1：使用 joblib (推荐) 或者使用 pickle # import pickle
    # 保存最大值，最小值，缩放比例和偏移量
