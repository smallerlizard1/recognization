...
def main():
    ...
    # joblib.dump(scaler, "gcn_bilstm_bnn_scaler.save")  # 方法1：使用 joblib (推荐) 或者使用 pickle # import pickle
    # 保存最大值，最小值，缩放比例和偏移量
...
# ===== 数据集统计 =====
# Train X shape: torch.Size([22282, 50, 25]), Train Y shape: torch.Size([22282])
# Validate X shape: torch.Size([6366, 50, 25]), Validate Y shape: torch.Size([6366])
# Test X shape: torch.Size([3182, 50, 25]), Test Y shape: torch.Size([3182])
# 训练集: 22282个样本 | 验证集: 6366 | 测试集: 3182
# 输入形状: torch.Size([22282, 50, 25]) | 标签形状: torch.Size([22282])
# 类别分布: [2962 5530 4130 4130 2765 2765]
