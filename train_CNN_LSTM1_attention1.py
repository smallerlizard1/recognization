...
class CNNBiLSTM(nn.Module):
    def __init__(self,feature_number, window_size, num_hidden_units, num_classes):
        ...
        # 自注意力层
        self.attention1 = SelfAttention(embed_size=cnn_output_dim, heads=4)
        # 自注意力后添加LayerNorm
        ...
        print("\n===== 模型结构 =====")
        print(f"输入形状: (batch, 1, {window_size}, {feature_number})")#64 1 20 8
    ...
    def forward(self, x):
        ...
        x = self.attention1(x, x, x)  # [batch, 1, cnn_output_dim]
...
def main():
    ...
    joblib.dump(scaler, "cnn_bilstm1_scaler.save")  # 方法1：使用 joblib (推荐) 或者使用 pickle # import pickle
    # 保存最大值，最小值，缩放比例和偏移量
    ...
    for epoch in range(num_epochs):
        ...
        if validate_loss < best_val_loss:
            ...
            no_improve = 0
            # 保存模型 # 保存最佳模型而不是最后模型
            torch.save(model, "cnn_bilstm1_attention1_model_all.pth")#保存完整模型
            torch.save(model.state_dict(), "cnn_bilstm1_attention1_model_params.pth")#只保存模型参数(state_dict)
        else:
            no_improve += 1
    ...
    try:
        model_test.load_state_dict(torch.load('cnn_bilstm1_attention1_model_params.pth',weights_only=True))#从文件加载 cnn_lstm model
...
if __name__ == "__main__":
    main()
    # attention_test()
# 正在读取文件: bt_msg_38.bin
# 文件大小: 1746944 字节
# 文件总帧数: 3412
# 读取 3412帧数据
# ./data20250513/bt_msg_38.bin
# 结果已保存至: /home/wdh/wdh_usr/test/ex_nn/cnn_lstm/data20250513/results_temp/00.png
# 正在读取文件: bt_msg_40.bin
# 文件大小: 1721344 字节
# 文件总帧数: 3362
# 读取 3362帧数据
# ./data20250513/bt_msg_40.bin
# 结果已保存至: /home/wdh/wdh_usr/test/ex_nn/cnn_lstm/data20250513/results_temp/01.png
# 正在读取文件: bt_msg_40.bin
# 文件大小: 1721344 字节
# 文件总帧数: 3362
# 读取 3362帧数据
# ./data20250513/bt_msg_40.bin
# 结果已保存至: /home/wdh/wdh_usr/test/ex_nn/cnn_lstm/data20250513/results_temp/02.png
# 正在读取文件: bt_msg_39.bin
# 文件大小: 939008 字节
# 文件总帧数: 1834
# 读取 1834帧数据
# ./data20250513/bt_msg_39.bin
# 结果已保存至: /home/wdh/wdh_usr/test/ex_nn/cnn_lstm/data20250513/results_temp/10.png
# 正在读取文件: bt_msg_40.bin
# 文件大小: 1721344 字节
# 文件总帧数: 3362
# 读取 3362帧数据
# ./data20250513/bt_msg_40.bin
# 结果已保存至: /home/wdh/wdh_usr/test/ex_nn/cnn_lstm/data20250513/results_temp/11.png
# 正在读取文件: bt_msg_41.bin
# 文件大小: 1882112 字节
# 文件总帧数: 3676
# 读取 3676帧数据
# ./data20250513/bt_msg_41.bin
# 结果已保存至: /home/wdh/wdh_usr/test/ex_nn/cnn_lstm/data20250513/results_temp/20.png
# 正在读取文件: bt_msg_42.bin
# 文件大小: 1669120 字节
# 文件总帧数: 3260
# 读取 3260帧数据
# ./data20250513/bt_msg_42.bin
# 结果已保存至: /home/wdh/wdh_usr/test/ex_nn/cnn_lstm/data20250513/results_temp/30.png
# 正在读取文件: bt_msg_42.bin
# 文件大小: 1669120 字节
# 文件总帧数: 3260
# 读取 3260帧数据
# ./data20250513/bt_msg_42.bin
# 结果已保存至: /home/wdh/wdh_usr/test/ex_nn/cnn_lstm/data20250513/results_temp/31.png
# 正在读取文件: bt_msg_42.bin
# 文件大小: 1669120 字节
# 文件总帧数: 3260
# 读取 3260帧数据
# ./data20250513/bt_msg_42.bin
# 结果已保存至: /home/wdh/wdh_usr/test/ex_nn/cnn_lstm/data20250513/results_temp/32.png
# 正在读取文件: bt_msg_42.bin
# 文件大小: 1669120 字节
# 文件总帧数: 3260
# 读取 3260帧数据
# ./data20250513/bt_msg_42.bin
# 结果已保存至: /home/wdh/wdh_usr/test/ex_nn/cnn_lstm/data20250513/results_temp/33.png
# 正在读取文件: bt_msg_42.bin
# 文件大小: 1669120 字节
# 文件总帧数: 3260
# 读取 3260帧数据
# ./data20250513/bt_msg_42.bin
# 结果已保存至: /home/wdh/wdh_usr/test/ex_nn/cnn_lstm/data20250513/results_temp/34.png
# 正在读取文件: bt_msg_42.bin
# 文件大小: 1669120 字节
# 文件总帧数: 3260
# 读取 3260帧数据
# ./data20250513/bt_msg_42.bin
# 结果已保存至: /home/wdh/wdh_usr/test/ex_nn/cnn_lstm/data20250513/results_temp/35.png
# 正在读取文件: bt_msg_42.bin
# 文件大小: 1669120 字节
# 文件总帧数: 3260
# 读取 3260帧数据
# ./data20250513/bt_msg_42.bin
# 结果已保存至: /home/wdh/wdh_usr/test/ex_nn/cnn_lstm/data20250513/results_temp/36.png
# 正在读取文件: bt_msg_42.bin
# 文件大小: 1669120 字节
# 文件总帧数: 3260
# 读取 3260帧数据
# ./data20250513/bt_msg_42.bin
# 结果已保存至: /home/wdh/wdh_usr/test/ex_nn/cnn_lstm/data20250513/results_temp/37.png
# [归一化参数]：最小值 [ -24.31816483  -43.64540863  -60.28747559 -407.2265625   -19.54257774
#   -42.14765549  -67.92297363 -413.87939453]
# [归一化参数]：最大值: [ 20.24599648  21.76288986  31.12976074 296.50878906  18.01611328
#   18.77695274  31.32751465 341.49169922]
# 0数据集划分结果:
# 训练集: 1386,(1386, 20, 8) 样本
# 验证集: 396,(396, 20, 8) 样本
# 测试集: 198,(198, 20, 8) 样本
# 0数据集划分结果:
# 训练集: 147,(147, 20, 8) 样本
...
# 测试集: 84,(84, 20, 8) 样本
# 1数据集划分结果:
# 训练集: 1021,(1021, 20, 8) 样本
# 验证集: 291,(291, 20, 8) 样本
# 测试集: 145,(145, 20, 8) 样本
# 1数据集划分结果:
# 训练集: 1570,(1570, 20, 8) 样本
# 验证集: 448,(448, 20, 8) 样本
# 测试集: 224,(224, 20, 8) 样本
# 2数据集划分结果:
# 训练集: 2195,(2195, 20, 8) 样本
# 验证集: 627,(627, 20, 8) 样本
# 测试集: 313,(313, 20, 8) 样本
# 3数据集划分结果:
# 训练集: 240,(240, 20, 8) 样本
...
# ===== 数据统计 =====
# Train X shape: torch.Size([8236, 20, 8]), Train Y shape: torch.Size([8236])
# Validate X shape: torch.Size([2348, 20, 8]), Validate Y shape: torch.Size([2348])
# Test X shape: torch.Size([1171, 20, 8]), Test Y shape: torch.Size([1171])
# 训练集: 8236个样本 | 验证集: 2348 | 测试集: 1171
# 输入形状: torch.Size([8236, 20, 8]) | 标签形状: torch.Size([8236])
# 类别分布: [2127 2591 2195 1323]

# feature_number:8,window_size:20
...
# Epoch 0: Train Loss 0.4651, Validate Loss 0.0948
# Epoch 1: Train Loss 0.0833, Validate Loss 0.0513
# Epoch 2: Train Loss 0.0628, Validate Loss 0.0278
# Epoch 3: Train Loss 0.0439, Validate Loss 0.0303
# Epoch 4: Train Loss 0.0429, Validate Loss 0.0240
# Epoch 5: Train Loss 0.0383, Validate Loss 0.0408
# Epoch 6: Train Loss 0.0317, Validate Loss 0.0255
# Epoch 7: Train Loss 0.0259, Validate Loss 0.0439
# Epoch 8: Train Loss 0.0300, Validate Loss 0.0098
# Epoch 9: Train Loss 0.0214, Validate Loss 0.0227
# Epoch 10: Train Loss 0.0256, Validate Loss 0.0207
# Epoch 11: Train Loss 0.0217, Validate Loss 0.0159
# Epoch 12: Train Loss 0.0199, Validate Loss 0.0216
# Epoch 13: Train Loss 0.0188, Validate Loss 0.0238
# Epoch 14: Train Loss 0.0212, Validate Loss 0.0517
# Epoch 15: Train Loss 0.0196, Validate Loss 0.0163
# Epoch 16: Train Loss 0.0139, Validate Loss 0.0109
# Epoch 17: Train Loss 0.0160, Validate Loss 0.0535
# Epoch 18: Train Loss 0.0127, Validate Loss 0.0073
# Epoch 19: Train Loss 0.0156, Validate Loss 0.0101
# Epoch 20: Train Loss 0.0132, Validate Loss 0.0277
# Epoch 21: Train Loss 0.0153, Validate Loss 0.0673
# Epoch 22: Train Loss 0.0175, Validate Loss 0.0294
# Epoch 23: Train Loss 0.0154, Validate Loss 0.0078
# Epoch 24: Train Loss 0.0142, Validate Loss 0.0320
# Epoch 25: Train Loss 0.0117, Validate Loss 0.0720
# Epoch 26: Train Loss 0.0148, Validate Loss 0.0394
# Epoch 27: Train Loss 0.0175, Validate Loss 0.0174
# Epoch 28: Train Loss 0.0090, Validate Loss 0.0059
# Epoch 29: Train Loss 0.0116, Validate Loss 0.0247
# Epoch 30: Train Loss 0.0070, Validate Loss 0.0079
# Epoch 31: Train Loss 0.0236, Validate Loss 0.0121
# Epoch 32: Train Loss 0.0168, Validate Loss 0.0072
# Epoch 33: Train Loss 0.0128, Validate Loss 0.0172
# Epoch 34: Train Loss 0.0099, Validate Loss 0.0187
# Epoch 35: Train Loss 0.0146, Validate Loss 0.0170
# Epoch 36: Train Loss 0.0072, Validate Loss 0.0118
# Epoch 37: Train Loss 0.0067, Validate Loss 0.0366
